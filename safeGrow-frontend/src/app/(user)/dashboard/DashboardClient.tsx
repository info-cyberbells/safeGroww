                ...
                return (
                  <div key={s.name} className="px-4 py-3 flex items-center gap-3 hover:bg-[#f8f9fa] transition-colors">
                    ...
                    <button
                      ...
                      disabled={!canToggle}
                      className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${!canToggle ? "bg-[#f1f3f5] text-[#ced4da] cursor-not-allowed" :
            ...
            {logs.map((log, i) => (
              <div key={i} className="px-4 py-3 flex items-start gap-3 hover:bg-[#f8f9fa] transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className={`inline-block mt-0.5 text-xs px-1.5 py-0.5 rounded font-medium ${log.type === "trade" ? "bg-[#e7f3ff] text-[#0066cc]" : "bg-[#f1f3f5] text-[#495057]"
                    }`}>{log.type}</span>
                </div>
